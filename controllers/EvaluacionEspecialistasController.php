...
class EvaluacionEspecialistasController extends ActiveRecord
{
    ...
    public static function buscarAPI()
    {
        ...
        try {
            ...
            // Condiciones base
            $condiciones = ["gra_clase = 4", "per_situacion IN (11)"];
            ...
            // CONSULTA PRINCIPAL basada en tu consulta exacta + plaza
            $sql = "SELECT 
                        ...
                        NVL(TRIM(org_plaza_desc), 'SIN PLAZA') as plaza
                    FROM morg 
    ...
    public static function obtenerGradosAPI()
    {
        ...
        getHeadersApi();
        try {
            // FILTRAR SOLO GRADOS DE ESPECIALISTAS (gra_clase = 4) que están en morg
